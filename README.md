...
<p> I am a self taught developer that is always looking to learn something new. With years in the hospitality industry, when the pandemic hit it was time for a change. I was drawn to development with massive amounts of experience working in a team-based environment. I have extensive experience with communication, marketing, and on the fly problem-solving. I love learning daily and seeking the 'why' and 'how'. Over this short time, I have earned numerous certificates with a focus on HTML/CSS, JavaScript, Node.js, Express, MongoDB with testing in Jest. I love having the ability to handle any task from front-end styling to back-end authentication and database construction. With the world of development always changing, a day will never be wasted because of something not learned and that excites me. </p>
